...
import com.openclassrooms.chatop.payload.request.SignupRequest;
import com.openclassrooms.chatop.payload.response.MessageResponse;
import com.openclassrooms.chatop.payload.response.UserInfoResponse;
import com.openclassrooms.chatop.repository.RoleRepository;
import com.openclassrooms.chatop.repository.UserRepository;
import com.openclassrooms.chatop.security.jwt.JwtUtils;
import com.openclassrooms.chatop.service.UserDetailsImpl;
import com.openclassrooms.chatop.service.UserDetailsServiceImpl;
...
public class LoginController {
	...
	public User getUserById(@PathVariable long id) {
		return (User) userService.loadUserById(id);
	}
